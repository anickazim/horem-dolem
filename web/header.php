...
<html lang="cz">
  <head>
	...
	<meta name="keywords" content="Horem Dolem, festival, Provodov">
	...
	<!-- ikonka-->
	<link rel="shortcut icon" href="fotky/grafika/logo-horem-dolem.png" type="image/x-icon">   
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="/workshopy">Workshopy</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="/kontakt">Náš tým</a>
                            <a class="dropdown-item" href="/kontakt/napistenam.php">Napiš nám</a>
                        </div>
                    </li>
                </ul>
            </div>
